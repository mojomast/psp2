// scr_user_guide.gml
// User guide and documentation for Pawn Stars Idle Game

// Display the complete user guide
function show_user_guide() {
    ...
    show_debug_message("   H - Show this help guide");
    show_debug_message("");
...
function show_quick_help() {
    show_debug_message("=== QUICK HELP ===");
    show_debug_message("T: Tests | R: Reset | S: Shop | I: Status | H: Help");
    show_debug_message("Resources accumulate automatically!");
    show_debug_message("🐕 Send pets exploring for bonus resources!");
}

// Show game statistics
function show_game_stats() {
    show_debug_message("=== GAME STATISTICS ===");
    show_debug_message("Time played: " + string(floor(global.idle_timer)) + " seconds");
    show_debug_message("Auto-save interval: " + string(global.auto_save_interval) + " seconds");
    show_debug_message("Idle speed multiplier: " + string(global.idle_speed) + "x");
    show_debug_message("Performance optimizations: ENABLED");
    show_debug_message("Pet update frequency: Every 0.5 seconds");
    show_debug_message("Resource calculation: Cached every 5 seconds");
}
